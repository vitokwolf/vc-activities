...
var taskFormHandler = function (event) {
    ...
    // has data attriibute, so get task id and call function to complete edit process
    if (isEdit) {
...
var completeEditTask = function (taskName, taskType, taskId) {
    ...
    // loop trough tasks array and task object with new content
...
var loadTasks = function () {
    ...
    // get task itmes from localStorage
    var savedTasks = localStorage.getItem('tasks');
    if (!savedTasks) {
        return false;
    };

    // convert savedTasks from string format back to into an array of objects
    savedTasks = JSON.parse(savedTasks);

    // loope through savedTasks array
